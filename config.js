...
module.exports = {
  VERSION: "v1.2.8",
  SESSION:levanter_61ea47b0b568541c8a21ed2e2deafbc73
  ...
  DEBUG: DEBUG,
  REMOVEBG:
    process.env.REMOVEBG_KEY === undefined ? "true" : process.env.REMOVEBG_KEY,
  ...
  STICKER_PACKNAME:abcdefg
    
    process.env.STICKER_PACKNAME === abcdefg
      ? "🥰,lyfe00011"
      : process.env.STICKER_PACKNAME,
  BRAINSHOP:
    process.env.BRAINSHOP === abcdefg
